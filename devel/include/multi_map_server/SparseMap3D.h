...
struct SparseMap3D_
{
  ...
  _info_type info;
   ...
   typedef std::vector< ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::multi_map_server::VerticalOccupancyGridList_<ContainerAllocator> >> _lists_type;
  _lists_type lists;
