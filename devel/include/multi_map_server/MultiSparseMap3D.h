...
struct MultiSparseMap3D_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::multi_map_server::SparseMap3D_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::multi_map_server::SparseMap3D_<ContainerAllocator> >> _maps_type;
  _maps_type maps;
